...
- Native command palette (`Ctrl + K`) - a dependency-free dialog/combobox with direct Control shortcuts for print (`P`), theme (`T`), language (`E`), GitHub (`G`), LinkedIn (`L`), and X (`X`).
